...
//  Loop
//
//  Wraps SPTAppRemote for Spotify playback control
//
...
final class SpotifyService: NSObject, ObservableObject {
    ...
    private func handlePauseError(_ message: String) {
        ...
        // Don't surface "request failed" etc for pause - often benign (nothing playing, transient)
    }
